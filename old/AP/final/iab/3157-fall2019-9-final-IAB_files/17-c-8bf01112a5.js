...
n("JI1W")
var w={buttonConfig(e,t){const n={title:e.name,classes:"widget btn instructure_external_tool_button"}
...
o=i.canvas_icon_class?"<i class='".concat(Object(x["a"])(i.canvas_icon_class),"' data-tool-id='").concat(i.id,"'></i>"):"<img src='".concat(Object(x["a"])(i.icon_url),"' data-tool-id='").concat(i.id,"'/>")
o+="&nbsp;".concat(Object(x["a"])(i.name))
e[o]=function(){n(i,t)}
...
return"<img src='"+Object(x["a"])(t)+"'/>"}function B(e){e.nodeChanged()
...
var d=new RegExp("("+j.join("|")+")");(c.attr("class")||"").match(d)&&i.addClass("for_inline_content").find(".disable_enhancement").show()
...
var D=n("i8i4")
var M=n.n(D)
const q={get more_external_tools(){return Object(x["a"])(v.t("more_external_tools","More External Tools"))}}
...
Promise.all([n.e(7),n.e(592)]).then(n.bind(null,"/wcz")).then(t=>{let n=t.default
...
const a=()=>o.open(n)
if(ENV.use_rce_enhancements){s.push(w.buttonConfig(n,e))
...
e.addButton("instructure_external_button_".concat(n.id),w.buttonConfig(n,e))}}s.length&&ENV.use_rce_enhancements&&e.ui.registry.addButton("lti_tool_dropdown",{onAction:()=>{const e=new CustomEvent("tinyRCE/onExternalTools",{detail:{ltiButtons:s}})
document.dispatchEvent(e)},icon:"lti",tooltip:"Apps"})
if(r.length){const t=function(){const t=w.clumpedButtonMapping(r,e,e=>o.open(e))
...
Promise.all([n.e(2),n.e(620)]).then(n.bind(null,"F+Bh")).then(t=>{let n=t.default
const o=new n(i.ed)
e.equationCB(o)})})
document.addEventListener("tinyRCE/initLinks",t=>{let n=t.detail
V.renderDialog(n.ed)
e.linksCB()})
document.addEventListener("tinyRCE/initImagePicker",t=>{Promise.all([n.e(2),n.e(9),n.e(10),n.e(102),n.e(115),n.e(613)]).then(n.bind(null,"Dwgn")).then(n=>{let i=n.default
const o=new i(t.detail.ed,t.detail.selectedNode)
e.imagePickerCB(o)})})
document.addEventListener("tinyRCE/initEquella",t=>{n.e(692).then(n.bind(null,"gg/z")).then(n=>{let i=n.default
i(t.detail.ed)
e.equellaCB()})})
document.addEventListener("tinyRCE/initExternalTools",t=>{G.init(t.detail.ed,t.detail.url,f["a"])
e.externalToolCB()})
document.addEventListener("tinyRCE/initRecord",t=>{Promise.all([n.e(38),n.e(693)]).then(n.bind(null,"xR7n")).then(n=>{let i=n.default
...
ee||(ee=(window.ENV.use_rce_enhancements?Promise.all([n.e(3),n.e(4),n.e(5),n.e(6),n.e(7),n.e(8),n.e(12),n.e(16),n.e(15),n.e(19),n.e(27),n.e(39),n.e(48),n.e(66),n.e(75),n.e(65),n.e(105),n.e(287)]).then(n.bind(null,"Idzl")):Promise.all([n.e(3),n.e(4),n.e(5),n.e(6),n.e(12),n.e(16),n.e(15),n.e(19),n.e(22),n.e(27),n.e(39),n.e(48),n.e(66),n.e(65),n.e(82),n.e(105),n.e(107),n.e(117),n.e(288)]).then(n.bind(null,"66gZ"))).then(e=>{this.RCE=e
W()
return e}))
...
//# sourceMappingURL=17-c-8bf01112a5.js.map